...
import type { Profile, MaintenanceRequest, RequestStatus, ThemePreference } from '@/types/database'
...
export default function UserDashboard() {
  ...
  const handleThemeToggle = async () => {
    ...
    const newTheme: ThemePreference = 
      profile.theme_preference === 'light' ? 'dark' : 
          ...
          <div className="flex justify-between items-center h-16">
            <div>
              ...
              <p className="text-sm text-gray-600">
                {profile?.visual_role} • {profile?.database_role === 'admin' ? 'Administrator' : 'User'}
              </p>
            </div>
                ...
                <form onSubmit={handleSubmitRequest} className="space-y-4">
                  ...
                  <div>
                    ...
                    <textarea
                      ...
                      onChange={(e) => setFormData({ ...formData, supportingReason: e.target.value })}
                      className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-green-500"
                      rows={2}
                  ...
                  {requests.map((request) => (
                    <div key={request.id} className="border border-gray-200 rounded-lg p-4">
                      <div className="flex justify-between items-start mb-2">
                        <div>
                          <h3 className="font-medium text-gray-900">{request.nature}</h3>
