...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen bg-[#FEFFD3] flex items-center justify-center p-4">
      {/* Login Card */}
      <div className="bg-white rounded-xl shadow-lg p-8 w-full max-w-md">
        ...
        <div className="mb-4">
          <h3 className="text-sm font-medium text-gray-700 mb-2">Google Account</h3>
          <button
        ...
        <div className="mb-4">
          <h3 className="text-sm font-medium text-gray-700 mb-2">Guest Account</h3>
          <button
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <select
                  ...
                  onChange={(e) => setGuestData({ ...guestData, visualRole: e.target.value as VisualRole })}
                  className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-green-500"
                >
              ...
              <div>
                ...
                <select
                  ...
                  onChange={(e) => setGuestData({ ...guestData, educationalLevel: e.target.value, department: '' })}
                  className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-green-500"
                >
              ...
              {guestData.educationalLevel === 'College' && (
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) => setGuestData({ ...guestData, department: e.target.value })}
                    className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-green-500"
