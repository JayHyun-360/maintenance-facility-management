...
export default function Sidebar({ activeTab, onTabChange, profile, userAvatar }: SidebarProps) {
      ...
      <div className="p-6 border-b border-white/10">
        <div className="flex items-center gap-3">
          ...
          <div className="flex-1 min-w-0">
            <h1 className="text-white font-bold text-lg truncate">Admin Dashboard</h1>
            <p className="text-white/60 text-xs truncate">Maintenance Facility</p>
          </div>
        </div>
      </div>
